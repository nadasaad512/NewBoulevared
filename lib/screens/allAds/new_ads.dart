 ...
 late VideoPlayerController controller;
  ...
  void initState() {
    ...
    UserApiController().AdDetalies(idAD: widget.indexAd!).then((value){
      ...
      _selected1=
      ad.category!=null?
      ad.category!.name.toString():"";
      _selected=
      ad.city!=null?
      ad.city!.name.toString():"";
      loedEdit=false;
            ...
            children: [
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: DropdownButton(
                              ...
                              underline: Container(),
                              menuMaxHeight: 500.h,
                              hint: Text(_selected1==null?
                              "القسم":_selected1,style: TextStyle(
                                  fontSize: 16.sp,
                                  color: Color(0xffC4C4C4),
                              ...
                              items: provider.categories.map<DropdownMenuItem<String>>((Categories value) {
                          ...
                          Container(
                            ...
                            child: DropdownButton(
                              ...
                              hint: Text(
                                _selected==null?
                                "المدينة":_selected,style: TextStyle(
                                  fontSize: 16.sp,
                                  color: Color(0xffC4C4C4),
              ...
              Expanded(
                ...
                child: PageView(
                  ...
                  children: [
                    provider.Normal_Price==null||provider.Special_Price==null?
                    LoedWidget():
                                ...
                                Column(
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: GridView.builder(
                                          scrollDirection: Axis.vertical,
                                          itemCount: provider.Normal_Price!.length,
                                          physics: NeverScrollableScrollPhysics(),
                                            ...
                                            return   InkWell(
                                              ...
                                              child: Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  mainAxisAlignment: MainAxisAlignment.center,
                                                  children: [
                                                    Text("${provider.Normal_Price![index].daysCount} يوم",style: TextStyle(
                                                        fontSize: 16.sp,
                                                        color:normallindex==index?
                                                    ...
                                                    SizedBox(width: 18.w,),
                                                    Text("${provider.Normal_Price![index].price} ريال",style: TextStyle(
                                                        color:normallindex==index?
                                ...
                                Column(
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: GridView.builder(
                                          scrollDirection: Axis.vertical,
                                          itemCount: provider.Special_Price!.length,
                                          gridDelegate:
                                          SliverGridDelegateWithFixedCrossAxisCount(
                                              childAspectRatio: 166.w / 54.h,
                                              crossAxisCount: 1,
                                              ...
                                              Container(
                                                ...
                                                child: Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Text("${provider.Special_Price![index].daysCount} يوم",style: TextStyle(
                                                        color:specialindex==index?
                                                        Colors.white:Colors.black,
                                                        fontSize: 16.sp,
                                                        fontWeight: FontWeight.w500
                                                    ...
                                                    SizedBox(width: 18.w,),
                                                    Text("${provider.Special_Price![index].price} ريال",style: TextStyle(
                                                        color:specialindex==index?
                                                        Colors.white:Color(0xff7B217E),
                                                        fontSize: 16.sp,
                                                        fontWeight: FontWeight.w600
