...
class AdmainAdScreen extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return  Consumer<AppProvider>(builder: (context, provider, _) {
     return provider.AdmainAd==[]||provider.AdmainAd.isEmpty?
        Column(
       mainAxisAlignment:
       ...
       GridView.builder(
         scrollDirection:
         Axis.vertical,
         itemCount: provider.AdmainAd.length - 1,
         gridDelegate:
         ...
         itemBuilder:
             (BuildContext, index) {
           return provider.AdmainAd[index + 1]
               .adType!
               .type ==
               "special"
               ? InkWell(
             ...
             child: Container(
               ...
               decoration: BoxDecoration(
                   ...
                   image: DecorationImage(
                       fit: BoxFit
                           .cover,
                       image: NetworkImage(provider.AdmainAd[index +
                           1]
                           .image
                           .toString()))),
               child: Stack(
                                                 ...
                                                 Navigator.pushReplacement(
                                                   ...
                                                   MaterialPageRoute(
                                                       builder: (context) => NewAdsScreen(
                                                         edit: true,
                                                         indexAd: provider.AdmainAd[index + 1].id!,
                                                       )),
                                                 );
                                               },
                                               child: Row(
                     ...
                     Row(
                       children: [
                         CircleAvatar(
                           ...
                           14,
                           backgroundImage:
                           NetworkImage(provider.user!.imageProfile.toString()),
                         ),
                         SizedBox(
                           width:
                           10.w,
                                     ...
                                     return Container(
                                         ...
                                         child: Column(
                                           children: [
                                             ...
                                             InkWell(
                                               onTap: () {
                                                 print(provider.AdmainAd[index + 1].id);
                                                 Navigator.pushReplacement(
                                                   context,
                                                   MaterialPageRoute(
                                                       builder: (context) => NewAdsScreen(
