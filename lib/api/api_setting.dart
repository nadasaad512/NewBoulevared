class ApiSettings {
  ...
  static String Filter({required int catId, required cityid}) => _API_URL + 'getAdsByCategory?category_id=$catId&city_id=$cityid';
...
//Ads
  ...
  //
  static String AdsDetalies({required idAds}) => _API_URL + 'viewAdsDetails?ad_id=$idAds';
